...
export function WineListPage() {
  ...
  return (
    <main className="bg-white pb-24">
      ...
      <div className="sticky top-16 z-30 -mx-4 mt-8 flex items-center justify-between bg-white px-4 py-3 tablet:-mx-6 tablet:px-6 desktop:hidden"><Button onClick={() => setIsFilterOpen(true)} size="icon" variant="secondary"><span aria-hidden="true">☷</span><span className="sr-only">필터</span></Button><Button onClick={() => void navigate('/login')}>와인 등록하기</Button></div>
