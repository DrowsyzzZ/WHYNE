  ...
  return (
    <main className="bg-white pb-24">
      ...
      <div className="mt-8 grid gap-10 desktop:grid-cols-[260px_1fr]">
        <div className="hidden desktop:block"><WineFilters filters={filters} onChange={updateFilters} onReset={() => updateFilters(initialFilters)} /><Button className="mt-10 w-full" onClick={() => void navigate('/login')}>와인 등록하기</Button></div>
