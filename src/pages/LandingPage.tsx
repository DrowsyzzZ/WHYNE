  ...
  return (
    <main className="overflow-hidden bg-white text-black">
      <section className="relative min-h-[465px] overflow-hidden rounded-b-xl text-white tablet:min-h-[625px] desktop:min-h-[660px]">
        <header className="container-whyne relative z-10 flex h-20 items-center justify-between tablet:h-24">
          <Link aria-label="WHYNE 홈" to="/">
            <Logo className="text-2xl" />
          </Link>
          <Link
            className="touch-target inline-flex items-center text-sm tablet:text-base"
            to="/login"
          >
            로그인
          </Link>
        </header>
        <div className="container-whyne relative z-10 pt-10 tablet:pt-14 desktop:pt-16">
          <h1 className="text-3xl font-bold leading-tight tracking-tight tablet:text-4xl desktop:text-[42px]">
            한 곳에서 관리하는
            <br />
            나만의 와인창고
          </h1>
      ...
      <section className="container-whyne pb-28 pt-28 tablet:pt-40">
        <div className="space-y-24 tablet:space-y-32 desktop:space-y-40">
          <section className="grid gap-10 desktop:grid-cols-[0.7fr_1.3fr] desktop:items-center">
            <div>
              <h2 className="text-2xl font-bold leading-tight tablet:text-3xl">
                매달 새롭게 만나는
                <br />
                와인 추천 콘텐츠
              </h2>
